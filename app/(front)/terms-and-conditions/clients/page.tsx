  ...
  const termsSections: Section[] = [
    {
      ...
      content: [
        'These terms form the agreement between CloudBreak group and the Client for the introduction of Workers via the Shiftly South Africa Platform.  acts as an employment agency under the Conduct Regulations 2003, facilitating connections between Clients and Workers for Assignments.',
    ...
    },
    {
      ...
      content: [
        'Both parties, as data controllers, must comply with Data Protection Legislation (e.g., South Africa GDPR, Data Protection Act 2018) when sharing personal data for compliance with Conduct Regulations and healthcare laws.',
    ...
    <div className="flex flex-col md:flex-row bg-gray-100 min-h-screen">
      ...
      <div className="flex flex-col md:flex-row gap-4 mb-6 px-6 ">
        ...
        <div className="max-w-5xl mx-auto bg-white shadow-xl rounded-xl p-8 md:p-12">
          <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-8">Shiftly South Africa Client Terms and Conditions</h1>
          <p className="text-gray-600 mb-8">
            Welcome to Shiftly South Africa, operated by CloudBreak Group Ltd. By accessing our Click Shifts platform as a Client, you agree to these terms. Please review them carefully.
          </p>
          ...
          <footer className="text-center text-gray-500 mt-10 border-t pt-6">
            <p>
              These terms may be updated periodically. Continued use of the Shiftly South Africa platform constitutes acceptance of the latest terms.
            </p>
          </footer>
        </div>
      </div>
