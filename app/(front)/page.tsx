...
export default async function Home() {
  ...
  return (
    <>
      <Head>
        <title>Shiftly | Home - Instant Staffing for SA Healthcare Providers</title>
        <meta
          name="description"
        ...
        />
        {/* Open Graph / Facebook */}
        <meta property="og:title" content="Shiftly | Home - Instant Staffing for SA Healthcare Providers" />
        <meta
        ...
        <meta name="twitter:title" content="Shiftly | Home - Instant Staffing for SA Healthcare Providers" />
        <meta
