...
export default async function Layout({ children }: { children: ReactNode }) {
  ...
  return (
    <div>
        ...
        <meta
          name="description"
          content="Shiftly connects care workers, nurses, and social workers with private clients, the NHS, and councils across the South Africa. Find extra shifts or hire trusted healthcare staff easily."
        />
        <meta
          name="keywords"
        ...
        <meta
          property="og:title"
          content="Shiftly | Home - Instant Staffing for South Africa Healthcare Providers"
        />
        <meta
