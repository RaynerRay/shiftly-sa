          ...
          <div className="md:w-1/2 text-center md:text-left">
            <div className="flex flex-col justify-center">
              ...
              >
                ...
                <span className="md:block hidden text-sky-600 mt-2">across South Africa</span>
              </h1>

              <p className="text-sm text-sky-800 md:text-lg md:mb-8 mb-2">
              Shiftly connects qualified, vetted, SA-based healthcare workers with private clients, care homes, clinics, the NHS, and local council healthcare services.
              ...
              <div className="rounded-2xl overflow-hidden shadow-2xl transform transition-transform hover:scale-102 relative z-10 border-4 border-white">
                <div className="relative aspect-w-1 aspect-h-1">
                  <Image
                    ...
                    src="/hero.jpg"
                    alt="South Africa healthcare professionals including nurses and carers working with patients"
                    priority
                  />
