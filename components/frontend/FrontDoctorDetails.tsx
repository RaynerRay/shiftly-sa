          ...
          <div className="p-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2  gap-4">
              <div className="flex items-center">
                ...
                <span className="uppercase">{doctorProfile?.firstName}</span>
              </div>
              <div className="flex items-center">
                <span className="mr-3">Last Name :</span>
                <span className="uppercase">{doctorProfile?.lastName}</span>
              </div>
              <div className="flex items-center">
                <span className="mr-3">Profession :</span>
                <span className="uppercase">{doctorProfile?.profession}</span>
              </div>
              {/* <div className="flex items-center">
              ...
              <div className="flex items-center">
                ...
                <span className="uppercase">{doctorProfile?.gender}</span>
              </div>
            </div>
          </div>
          <div className="p-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2  gap-4">
              ...
              <div className="flex items-center">
                ...
                <span className="uppercase">{doctorProfile?.yearsOfExperience}</span>
              </div>
            </div>
          ...
          <div className="p-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2  gap-4">
              ...
              <div className="flex items-center">
                ...
                <span className="uppercase">{doctorProfile?.city}</span>
              </div>
              {/* <div className="flex items-center">
