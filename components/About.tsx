    ...
    <section className="flex flex-col space-y-12 mt-8 mb-10 ">
      ...
      <div className="flex flex-col md:flex-row items-center space-y-6 md:space-y-0 md:space-x-8">
        ...
        <div className="w-full md:w-1/2 space-y-4">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800">
            Welcome to Shiftly - Instant Staffing for South Africa Healthcare Providers
          </h2>
          <p className="text-gray-600">
            Shiftly revolutionises healthcare staffing in the South Africa, offering instant connections between healthcare providers and qualified professionals. Our platform ensures you find the right shifts or staff seamlessly, anytime.
          </p>
      ...
      <div className="bg-gray-50 p-8 rounded-lg shadow ">
        ...
        <p className="text-gray-600 mb-4">
          Shiftly simplifies staffing challenges with cutting-edge technology. Here is why Shiftly is the go-to platform for healthcare staffing in the South Africa:
        </p>
